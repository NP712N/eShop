...
namespace eShop.Data.Configurations {
    public class ProductTranslationConfiguration : IEntityTypeConfiguration<ProductInTranslation> {
        public void Configure(EntityTypeBuilder<ProductInTranslation> builder) {
